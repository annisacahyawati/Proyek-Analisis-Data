...
def plot_monthly_pattern(df_cleaned):
    ...
    # Menyorot bulan dengan rata-rata PM2.5 lebih dari 70
    highlight = monthly_avg[monthly_avg['PM2.5'] > 70]
    plt.scatter(highlight['month'], highlight['PM2.5'], color='red', s=100, zorder=5, label='PM2.5 Tinggi')
